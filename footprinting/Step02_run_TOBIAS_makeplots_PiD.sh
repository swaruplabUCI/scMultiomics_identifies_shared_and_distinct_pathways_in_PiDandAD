...
BAMFILE=$1
NAME=$2
INDIR=/dfs7/swaruplab/smorabit/analysis/PiD_2021/trackhubs/data/bams/merged
OUTDIR=/dfs7/swaruplab/smorabit/analysis/PiD_2021/tobias
...
MERGED_PEAKS=${INDIR}/pid_peaks_merged.bed ## From Seurat
MERGED_PEAKS_HEADER=${INDIR}/merged_peaks_header.txt ## header
...
echo $name;
cd /dfs7/swaruplab/smorabit/analysis/PiD_2021/tobias;
