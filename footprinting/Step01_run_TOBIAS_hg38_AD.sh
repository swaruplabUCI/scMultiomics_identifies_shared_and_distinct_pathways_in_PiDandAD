...
BAMFILE=$1
NAME=$2
INPUT_DIR=/dfs7/swaruplab/smorabit/analysis/AD_NucSeq_2019/atac_analysis/all_data/trackhubs/data/bams/merged/celltypes
OUTPUT_DIR=/dfs7/swaruplab/smorabit/analysis/PiD_2021/tobias/AD
...
echo $name;
cd ${OUTPUT_DIR};
sbatch ./Step01_run_tobias.sh $folder $name;
done
