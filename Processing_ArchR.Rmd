...
setwd('~/swaruplab/smorabit/analysis/PiD_2021/ArchR/')
...
# which(proj$TSSEnrichment > 6 & proj$nFrags > 1500) %>% length

proj<- proj[which(proj$TSSEnrichment > 6 & proj$nFrags > 1500)]
table(proj$Sample)
...
Make my own expression plot with blackjack and hoookers
