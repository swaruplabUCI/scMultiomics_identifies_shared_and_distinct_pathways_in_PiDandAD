...
#SBATCH --mem 96G
#SBATCH --array=1-23 # number of clusters
#SBATCH --time=4:00:00
...
outdir="/dfs7/swaruplab/smorabit/analysis/PiD_2021/snRNA/DEGs/data/cluster_markers/"
type="markers" # type of DEGs to run. "markers" or "condition"
name="annotation" # name to append to output files
cluster="annotation" # column in the seurat object with cluster / cell type information
